...
// functions 2
  ...
  { "fwdRate", pyQfFwdRate, METH_VARARGS, "fwd rate between two maturities." },
  { "volCreate", pyQfVolCreate, METH_VARARGS, "creates a vol curve." },
  { "spotVol", pyQfSpotVol, METH_VARARGS, "spot vol to maturity." },
  { "fwdVol", pyQfFwdVol, METH_VARARGS, "fwd vol between two maturities." },
  {NULL, NULL, 0, NULL}
};
